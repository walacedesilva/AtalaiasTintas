...
> 133 |     await page.getByRole('textbox', { name: 'Senha' }).fill('admin123');
      |                                    ^ Error: locator.fill: Error: strict mode violation: getByLabel('Senha') resolved to 2 elements:
  ...
  152 |     await expect(page.getByRole('textbox', { name: 'Senha' })).toBeFocused();
  153 | 
  ...
  164 |     await page.getByRole('textbox', { name: 'Senha' }).fill('testpass123');
  ...
  177 |     await expect(page.getByRole('heading', { name: 'Atalaia Tintas' })).toBeVisible();
  178 |     await expect(page.getByLabel('Nome de usuário')).toBeVisible();
  179 |     await expect(page.getByRole('textbox', { name: 'Senha' })).toBeVisible();
  ...
  184 |     await page.getByRole('textbox', { name: 'Senha' }).fill('password123');
  185 |     
  186 |     // Inputs should be filled correctly
  187 |     await expect(page.getByLabel('Nome de usuário')).toHaveValue('mobile');
  188 |     await expect(page.getByRole('textbox', { name: 'Senha' })).toHaveValue('password123');
  189 |   });
  190 | });
```