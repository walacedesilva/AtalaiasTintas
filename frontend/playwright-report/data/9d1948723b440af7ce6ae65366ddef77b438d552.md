...
Locator: getByText('Atalaia Tintas')
Expected: visible
Error: strict mode violation: getByText('Atalaia Tintas') resolved to 3 elements:
    1) <h1 class="text-3xl font-bold text-white tracking-tight mb-3">Atalaia Tintas</h1> aka locator('h1')
    2) <p class="mt-10 text-xs text-slate-600">Atalaia Tintas © 2026</p> aka getByText('Atalaia Tintas ©')
    3) <span class="text-lg font-bold text-slate-900">Atalaia Tintas</span> aka locator('span').filter({ hasText: 'Atalaia Tintas' })

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for getByText('Atalaia Tintas')
