    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('responsavel', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='lojas_responsavel', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'verbose_name': 'Loja',
